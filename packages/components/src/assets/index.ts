...
export { default as SunIconUrl } from './sun.svg';
export { default as MoonIconUrl } from './moon.svg';
export { default as SettingsIconUrl } from './settings.svg';
export { default as ConnectIconUrl } from './connect.svg';
export { default as DisconnectIconUrl } from './disconnect.svg';
export { default as LoadingIconUrl } from './loading.svg';
export { default as CorrectIconUrl } from './correct.svg';
export { default as IncorrectIconUrl } from './incorrect.svg';
export { default as TokenIconUrl } from './token.svg';
export { default as WalletIconUrl } from './walletsFound.svg';
export { default as ImportIconUrl } from './import.svg';
export { default as DownloadIconUrl } from './download.svg';
export { default as ExpandIconUrl } from './expand.svg';
export { default as DetailsIconUrl } from './details.svg';
export { default as ChangeIconUrl } from './change.svg';
export { default as NewWalletIconUrl } from './newWallet.svg';
export { default as RecipientIconUrl } from './recipient.svg';
export { default as SignIconUrl } from './sign.svg';
